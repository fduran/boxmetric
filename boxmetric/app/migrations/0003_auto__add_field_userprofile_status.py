...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app_userprofile', 'status', self.gf('django.db.models.fields.CharField')(default=u'0', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.status'
        db.delete_column('app_userprofile', 'status')
