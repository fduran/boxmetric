...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserEvent.timestamp'
        db.add_column('app_userevent', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserEvent.timestamp'
        db.delete_column('app_userevent', 'timestamp')
